...
export class ConfigurationComponent implements OnInit {
  ...
  setHeaderBackColor(color: any): void {
  ...
  setRtlLayout(e: any): void {
    const flag = !!e.target.checked;
    this.changeRtlLayout(flag);
  }

  changeRtlLayout(flag: any): void {
    if (flag) {
  ...
  setMenuFixedLayout(e: any): void {
    const flag = !!e.target.checked;
    this.changeMenuFixedLayout(flag);
  }

  changeMenuFixedLayout(flag: any): void {
    setTimeout(() => {
      if (flag) {
  ...
  setHeaderFixedLayout(e: any): void {
    const flag = !!e.target.checked;
    this.changeHeaderFixedLayout(flag);
  }

  changeHeaderFixedLayout(flag: any): void {
    if (flag) {
  ...
  setBoxLayout(e: any): void {
    const flag = !!e.target.checked;
    this.changeBoxLayout(flag);
  }

  changeBoxLayout(flag: any): void {
    if (flag) {
  ...
  setHeaderBackground(background: any): void {
