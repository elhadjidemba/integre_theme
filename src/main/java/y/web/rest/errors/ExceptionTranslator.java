...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    @ExceptionHandler
    public Mono<ResponseEntity<Problem>> handleEmailAlreadyUsedException(y.service.EmailAlreadyUsedException ex, ServerWebExchange request) {
    ...
    @ExceptionHandler
    public Mono<ResponseEntity<Problem>> handleUsernameAlreadyUsedException(y.service.UsernameAlreadyUsedException ex, ServerWebExchange request) {
        LoginAlreadyUsedException problem = new LoginAlreadyUsedException();
        return create(problem, request, HeaderUtil.createFailureAlert(applicationName,  true, problem.getEntityName(), problem.getErrorKey(), problem.getMessage()));
    }

    @ExceptionHandler
    public Mono<ResponseEntity<Problem>> handleInvalidPasswordException(y.service.InvalidPasswordException ex, ServerWebExchange request) {
